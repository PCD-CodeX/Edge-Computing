...
const char* default_BROKER_MQTT = "172.212.81.123"; // IP do Broker MQTT
...
const char* default_TOPICO_PUBLISH_2 = "/TEF/device007/attrs/l"; // Tópico MQTT de envio de informações para Broker
const char* default_TOPICO_PUBLISH_3 = "/TEF/device007/attrs/t"; // Tópico MQTT de envio de informações para Broker
const char* default_TOPICO_PUBLISH_4 = "/TEF/device007/attrs/h"; // Tópico MQTT de envio de informações para Broker
